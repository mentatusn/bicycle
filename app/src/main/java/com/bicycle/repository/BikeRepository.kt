...
class BikeRepository {
    private val sharedPreferences: SharedPreferences =
        MyApplication.applicationContext().getSharedPreferences(Const.sharedBikeDB, Context.MODE_PRIVATE)
    ...
    private fun loadBikes() {
        if (sharedPreferences.getString(Const.sharedBike, null) == null) {
    ...
    private fun saveBikesData(bikes: List<Bike>) {
        ...
        editor.putString(Const.sharedBike, json)
        editor.apply()
    }

    private fun loadBikesData(): List<Bike> {
        val json = sharedPreferences.getString(Const.sharedBike, null)
